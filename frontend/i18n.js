...
const I18N = {
  en: {
    ...
    "app.update_available": "A new version {version} is available.",
    "app.update_open": "Go to updates",
    "area.add_sub": "Add subarea",
    ...
    "area.sub_name_example": "e.g. Windows",
    "area.title": "Area",
    ...
    "ask.reboot_grant": "Allow {name} to run and schedule reboots?",
    "ask.reboot_revoke": "Withdraw the right to reboot from {name}? Any open sessions of that account end.",
    ...
    "login.mfa_code": "Code",
    "login.mfa_hint": "Enter the six-digit code from your authenticator app. A recovery code works too — each of them once.",
    "login.mfa_missing": "Please enter the code.",
    ...
    "msg.update_found": "Update {version} found.",
    "msg.update_none": "No update available — you are up to date.",
    "msg.update_fetching": "Fetching package from GitHub…",
    ...
    "msg.pw_short": "The password must have at least {anzahl} characters",
    ...
    "msg.reboot_granted": "{name} may now reboot",
    "msg.reboot_revoked": "{name} may no longer reboot",
    ...
    "pwforce.hint": "This account still uses the initial password. Please choose your own before continuing.",
    "pwforce.submit": "Set password",
    "pwforce.title": "Choose a new password",
    ...
    "settings.agents.distro": "Distribution",
    "settings.agents.distro_deb": "Debian, Ubuntu — .deb",
    "settings.agents.distro_dnf": "Red Hat, Oracle, Rocky, AlmaLinux — .rpm",
    "settings.agents.distro_suse": "SUSE, openSUSE — .rpm",
    "settings.agents.download_deb": "Download",
    "settings.agents.download_msi": "Download",
    "settings.agents.download_rpm": "Download",
    ...
    "settings.agents.rpm_pkg": "<b>Linux</b> · .rpm for Red Hat, Oracle, Rocky, AlmaLinux and SUSE<br>",
    ...
    "settings.mfa.confirm": "Confirm and switch on",
    "settings.mfa.confirm_code": "Code from the app",
    "settings.mfa.confirm_hint": "Not switched on until a code has been confirmed. If you stop here, nothing changes.",
    "settings.mfa.copied": "Recovery codes copied.",
    "settings.mfa.copy": "Copy codes",
    "settings.mfa.copy_failed": "Could not copy — please select the codes by hand.",
    "settings.mfa.forced": "This installation requires two-step sign-in for administrators. Until it is set up, this account cannot do anything else.",
    "settings.mfa.hint": "In addition to the password, a six-digit code from an app on your phone. <b>Google Authenticator, Microsoft Authenticator, Aegis, 2FAS, Bitwarden, 1Password and KeePassXC</b> all work — this is the standard procedure (TOTP, RFC 6238), not a product of ours.<br><br>The app needs no network connection. It computes the code from a shared secret and the current time, which is why the clock on the phone has to be roughly right.",
    "settings.mfa.manual": "Cannot scan? Enter this key in the app by hand:",
    "settings.mfa.need_both": "Password and code are both required.",
    "settings.mfa.need_code": "Please enter the code from the app.",
    "settings.mfa.off_hint": "Switching off needs the password and a current code — otherwise a stolen session would be enough to get rid of exactly the thing it is meant to protect.",
    "settings.mfa.on": "On",
    "settings.mfa.policy": "Required for administrators",
    "settings.mfa.policy_hint": "Requires every administrator account to use two-step sign-in. Set it up on your own account first under <b>Account</b> — otherwise the switch refuses, and rightly so: you would be locking yourself out.<br><br>Administrators who have not set it up yet are asked to do so at the next sign-in and cannot do anything else until they have. Nobody can switch theirs off while this is on.",
    "settings.mfa.policy_off": "Optional. Everyone decides for their own account.",
    "settings.mfa.policy_on": "Required. Administrators without it are asked to set it up before anything else.",
    "settings.mfa.policy_title": "Two-step sign-in for administrators",
    "settings.mfa.recovery_hint": "<b>Write these down now.</b> They are shown this once and never again — stored is only their hash. Each one works once, in place of the code from the app, for instance if the phone is gone.",
    "settings.mfa.saved": "I have written them down",
    "settings.mfa.scan": "Scan this code with the app:",
    "settings.mfa.setup": "Set up",
    "settings.mfa.state": "State",
    "settings.mfa.title": "Two-step sign-in",
    "settings.mfa.turn_off": "Switch off",
    "settings.mfa.turned_off": "Two-step sign-in switched off.",
    ...
    "settings.tab.syslog": "Syslog",
    "settings.syslog.title": "Central logging",
    "settings.syslog.hint": "Forwards every entry of the audit log and every finished job to a syslog server or SIEM. <b>Off by default.</b><br><br>CO-37 otherwise writes only into its own database. For a single small network that is enough; in an operation with a log server it is the difference between usable and not.<br><br>The audit log in the database stays the truth \u2014 this is the copy. If the copy fails, nothing about the entry changes.",
    "settings.syslog.host": "Target",
    "settings.syslog.host_example": "e.g. 192.168.2.20",
    "settings.syslog.port": "Port",
    "settings.syslog.transport": "Transport",
    "settings.syslog.facility": "Facility",
    "settings.syslog.verify": "Check the server certificate",
    "settings.syslog.verify_hint": "Only applies to TLS. Leave on unless the log server uses a certificate of its own.",
    "settings.syslog.save": "Save",
    "settings.syslog.saved": "Logging settings saved",
    "settings.syslog.test": "Send test message",
    "settings.syslog.testing": "Sending\u2026",
    "settings.syslog.test_ok": "Test message delivered to {ziel}.",
    "settings.syslog.test_failed": "Test message did not get through: {grund}",
    "settings.syslog.state_title": "State",
    "settings.syslog.enabled": "Forwarding on",
    "settings.syslog.enable_hint": "Test first, then switch on. Without a target address it cannot be switched on.",
    "settings.syslog.on": "Forwarding switched on",
    "settings.syslog.off": "Forwarding switched off",
    "settings.syslog.queue_ok": "Queue: {q} messages waiting, none dropped.",
    "settings.syslog.dropped": "<b>{n} messages dropped</b> \u2014 the queue was full because the log server could not be reached. Queue right now: {q}.",
    ...
    "settings.update.remote_title": "Update from GitHub",
    "settings.update.check": "Check for updates",
    "settings.update.available": "Available",
    "settings.update.fetch": "Fetch from GitHub",
    "settings.update.auto": "Check for updates automatically once a day",
    "settings.update.auto_hint": "Only while the interface is open. A locked-down server without internet access can leave this off and upload the package by hand.",
    "settings.update.remote_found": "Update {version} available.",
    "settings.update.remote_current": "Up to date (last checked {wann}).",
    "settings.update.remote_never": "Not checked yet.",
    ...
    "settings.users.may_reboot": "May also run and schedule reboots",
    "settings.users.may_reboot_hint": "Without this, the account can scan and patch, but not restart hosts. Administrators may always do so.",
    "settings.users.new": "Create a new user",
    "settings.users.password": "Password",
    "settings.users.reboot_allowed": "may reboot",
    "settings.users.reboot_grant": "Allow reboots",
    "settings.users.reboot_revoke": "Withdraw reboots",
    ...
    "upd.log.deps_none": "No package changes",
    "upd.log.deps_plan": "pip would install: {pakete}",
    "upd.log.deps_preview_failed": "Dry run not possible, installing anyway: {fehler}",
  ...
  de: {
    ...
    "app.update_available": "Version {version} steht bereit.",
    "app.update_open": "Zu den Updates",
    "area.add_sub": "Unterbereich anlegen",
    ...
    "area.sub_name_example": "z.B. Windows",
    "area.title": "Bereich",
    ...
    "ask.reboot_grant": "Soll {name} Neustarts ausführen und einplanen dürfen?",
    "ask.reboot_revoke": "{name} das Recht auf Neustarts entziehen? Offene Sitzungen dieses Kontos enden dabei.",
    ...
    "login.mfa_code": "Code",
    "login.mfa_hint": "Sechsstelliger Code aus der Authenticator-App. Ein Wiederherstellungscode geht auch — jeder davon einmal.",
    "login.mfa_missing": "Bitte den Code eingeben.",
    ...
    "msg.update_found": "Update {version} gefunden.",
    "msg.update_none": "Kein Update verfügbar — alles aktuell.",
    "msg.update_fetching": "Paket wird von GitHub geholt…",
    ...
    "msg.pw_short": "Passwort muss mindestens {anzahl} Zeichen haben",
    ...
    "msg.reboot_granted": "{name} darf jetzt neu starten",
    "msg.reboot_revoked": "{name} darf nicht mehr neu starten",
    ...
    "pwforce.hint": "Dieses Konto benutzt noch das Anfangspasswort. Bitte vor dem Weiterarbeiten ein eigenes vergeben.",
    "pwforce.submit": "Passwort setzen",
    "pwforce.title": "Neues Passwort vergeben",
    ...
    "settings.agents.download_rpm": "Herunterladen",
    ...
    "settings.agents.rpm_pkg": "<b>Linux</b> · .rpm für Red Hat, Oracle, Rocky, AlmaLinux und SUSE<br>",
    ...
    "settings.mfa.cancel": "Abbrechen",
    "settings.mfa.confirm": "Bestätigen und einschalten",
    "settings.mfa.confirm_code": "Code aus der App",
    "settings.mfa.confirm_hint": "Scharf erst, wenn ein Code bestätigt wurde. Wer hier abbricht, ändert nichts.",
    "settings.mfa.copied": "Wiederherstellungscodes kopiert.",
    "settings.mfa.copy": "Codes kopieren",
    "settings.mfa.copy_failed": "Kopieren nicht möglich — bitte die Codes von Hand markieren.",
    "settings.mfa.forced": "In dieser Anlage ist die Anmeldung in zwei Schritten für Administratoren Pflicht. Bis sie eingerichtet ist, kann dieses Konto nichts anderes tun.",
    "settings.mfa.hint": "Zusätzlich zum Passwort ein sechsstelliger Code aus einer App auf dem Telefon. <b>Google Authenticator, Microsoft Authenticator, Aegis, 2FAS, Bitwarden, 1Password und KeePassXC</b> funktionieren alle — das ist das übliche Verfahren (TOTP, RFC 6238) und kein eigenes.<br><br>Die App braucht keine Netzverbindung. Sie rechnet den Code aus einem gemeinsamen Geheimnis und der aktuellen Uhrzeit aus — deshalb muss die Uhr des Telefons ungefähr stimmen.",
    "settings.mfa.manual": "Scannen geht nicht? Diesen Schlüssel von Hand in der App eintragen:",
    "settings.mfa.need_both": "Passwort und Code werden beide gebraucht.",
    "settings.mfa.need_code": "Bitte den Code aus der App eingeben.",
    "settings.mfa.off_hint": "Zum Abschalten braucht es Passwort und einen gültigen Code — sonst genügte eine übernommene Sitzung, um genau das loszuwerden, wovor sie schützen soll.",
    "settings.mfa.on": "Ein",
    "settings.mfa.policy": "Für Administratoren verpflichtend",
    "settings.mfa.policy_hint": "Verlangt sie von jedem Administratorkonto. Erst am eigenen Konto unter <b>Konto</b> einrichten — sonst weist der Schalter das ab, und das zu Recht: man würde sich selbst aussperren.<br><br>Administratoren, die sie noch nicht haben, werden bei der nächsten Anmeldung dazu aufgefordert und kommen bis dahin an nichts anderes heran. Abschalten kann sie, solange dies steht, niemand.",
    "settings.mfa.policy_off": "Freiwillig. Jeder entscheidet für sein eigenes Konto.",
    "settings.mfa.policy_on": "Verpflichtend. Administratoren ohne sie werden vor allem anderen zur Einrichtung aufgefordert.",
    "settings.mfa.policy_title": "Anmeldung in zwei Schritten für Administratoren",
    "settings.mfa.recovery_hint": "<b>Jetzt aufschreiben.</b> Sie werden dieses eine Mal angezeigt und nie wieder — gespeichert ist nur ihr Hash. Jeder gilt einmal, anstelle des Codes aus der App, etwa wenn das Telefon weg ist.",
    "settings.mfa.saved": "Ich habe sie aufgeschrieben",
    "settings.mfa.scan": "Diesen Code mit der App abscannen:",
    "settings.mfa.setup": "Einrichten",
    "settings.mfa.state": "Zustand",
    "settings.mfa.title": "Anmeldung in zwei Schritten",
    "settings.mfa.turn_off": "Abschalten",
    "settings.mfa.turned_off": "Anmeldung in zwei Schritten abgeschaltet.",
    ...
    "settings.tab.checkmk": "Checkmk",
    "settings.tab.syslog": "Syslog",
    "settings.syslog.title": "Zentrale Protokollierung",
    "settings.syslog.hint": "Leitet jeden Eintrag des Pr\u00fcfprotokolls und jeden abgeschlossenen Auftrag an einen syslog-Server oder ein SIEM weiter. <b>Ab Werk aus.</b><br><br>CO-37 schreibt sonst ausschlie\u00dflich in die eigene Datenbank. F\u00fcr ein einzelnes kleines Netz reicht das; in einem Betrieb mit Logserver ist es der Unterschied zwischen einsetzbar und nicht.<br><br>Das Pr\u00fcfprotokoll in der Datenbank bleibt die Wahrheit \u2014 das hier ist die Kopie. Geht die Kopie schief, \u00e4ndert das am Eintrag nichts.",
    "settings.syslog.host": "Ziel",
    "settings.syslog.host_example": "z. B. 192.168.2.20",
    "settings.syslog.port": "Port",
    "settings.syslog.transport": "\u00dcbertragung",
    "settings.syslog.facility": "Facility",
    "settings.syslog.verify": "Zertifikat der Gegenstelle pr\u00fcfen",
    "settings.syslog.verify_hint": "Gilt nur f\u00fcr TLS. An lassen, au\u00dfer der Logserver hat ein eigenes Zertifikat.",
    "settings.syslog.save": "Speichern",
    "settings.syslog.saved": "Einstellungen zur Protokollierung gespeichert",
    "settings.syslog.test": "Testmeldung senden",
    "settings.syslog.testing": "Wird gesendet\u2026",
    "settings.syslog.test_ok": "Testmeldung an {ziel} zugestellt.",
    "settings.syslog.test_failed": "Testmeldung ging nicht durch: {grund}",
    "settings.syslog.state_title": "Zustand",
    "settings.syslog.enabled": "Weiterleitung eingeschaltet",
    "settings.syslog.enable_hint": "Erst testen, dann einschalten. Ohne Zieladresse l\u00e4sst sie sich nicht einschalten.",
    "settings.syslog.on": "Weiterleitung eingeschaltet",
    "settings.syslog.off": "Weiterleitung ausgeschaltet",
    "settings.syslog.queue_ok": "Warteschlange: {q} Meldungen unterwegs, nichts verworfen.",
    "settings.syslog.dropped": "<b>{n} Meldungen verworfen</b> \u2014 die Warteschlange war voll, weil der Logserver nicht erreichbar war. Warteschlange gerade: {q}.",
    ...
    "settings.update.remote_title": "Update von GitHub",
    "settings.update.check": "Nach Updates suchen",
    "settings.update.available": "Verfügbar",
    "settings.update.fetch": "Von GitHub holen",
    "settings.update.auto": "Täglich automatisch nach Updates suchen",
    "settings.update.auto_hint": "Nur solange die Oberfläche geöffnet ist. Ein abgeschotteter Server ohne Internet-Zugang lässt den Haken aus und lädt das Paket von Hand hoch.",
    "settings.update.remote_found": "Update {version} verfügbar.",
    "settings.update.remote_current": "Aktuell (zuletzt geprüft {wann}).",
    "settings.update.remote_never": "Noch nicht gesucht.",
    ...
    "settings.users.may_reboot": "Darf auch Neustarts ausführen und planen",
    "settings.users.may_reboot_hint": "Ohne dieses Recht kann das Konto scannen und patchen, aber keine Hosts neu starten. Administratoren dürfen es immer.",
    "settings.users.new": "Neuen Benutzer anlegen",
    "settings.users.password": "Passwort",
    "settings.users.reboot_allowed": "darf neu starten",
    "settings.users.reboot_grant": "Neustarts erlauben",
    "settings.users.reboot_revoke": "Neustarts entziehen",
    ...
    "upd.log.deps_none": "Keine Paketänderungen",
    "upd.log.deps_plan": "pip würde installieren: {pakete}",
    "upd.log.deps_preview_failed": "Trockenlauf nicht möglich, wird trotzdem installiert: {fehler}",
