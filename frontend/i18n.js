...
const I18N = {
  en: {
    ...
    "pkg.log.no_msi_python": "No Windows package: the Python distribution could not be downloaded. The server needs access to python.org, or place the file by hand at packaging/cache/python-3.12.8-embed-amd64.zip",
  ...
  de: {
    ...
    "pkg.log.no_msi_python": "Kein Windows-Paket: die Python-Distribution konnte nicht geladen werden. Der Server braucht Zugriff auf python.org, oder die Datei von Hand ablegen unter packaging/cache/python-3.12.8-embed-amd64.zip",
